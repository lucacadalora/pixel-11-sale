(function () {
  ...
  const I18N = {
    en: {
      ...
      nowBody: "sealed pixel 11 from changi. add to bag on the sale page.",
    ...
    id: {
      ...
      nowBody: "pixel 11 sealed dari changi. masukkan ke bag di halaman sale.",
